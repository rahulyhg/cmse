    ...
    public function ajax()
    {
        return $this->datatables
            ...
            ->editColumn('wards_count',function($data){
                return "<span class='badge bg-color-greenLight '>".$data->wards->count()."</span>" . " <!--a href='wards?hospital_id=".$data->id."'><button><li class='fa fa-search'></li></button></a--> <a href='wards/create?hospital_id=".$data->id."'><button><li class='fa fa-plus'></li></button></a>";
            })
            ->make(true);
    }
